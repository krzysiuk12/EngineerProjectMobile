...
public class GetLocationByIdAsyncTask extends AsyncTask<Void, Void, Location> {
    ...
    protected Location doInBackground(Void... voids) {
        ResponseEntity<Location> responseEntity = HttpRequestBuilder.getRestTemplateWithJacksonConverter()
                .exchange(new LocationsPathBuilder().buildLocationByIdPath(id), HttpMethod.GET, new HttpEntity<Location>(HttpRequestBuilder.getHttpHeadersWithHeader(token)), Location.class);
